...
namespace DebugPlus.Patches
{
    ...
    internal class LogWarningPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools
                ...
                .SingleDebug(m =>
                    m.Name == nameof(Debug.LogWarning)
        ...
        {
            if (!DebugPlusConfig.UnityWarningLogging.Value)
            {
                return;
            }
            ...
            {
                DebugPlus.Log.LogWarning(Format.FormatString(s));
                return;
            }

            DebugPlus.Log.LogWarning(message);
        }
    }
    ...
    internal class LogWarningContextPatch : ModulePatch
    {
        ...
        public static void PatchPostfix(object message, Object context)
        {
            ...
            if (message is string s)
            {
                DebugPlus.Log.LogWarning($"GameObject: {context}\n{Format.FormatString(s)}");
                return;
            }
    ...
    internal class LogWarningFormatPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools
                .GetDeclaredMethods(typeof(Debug))
                .SingleDebug(m =>
                    m.Name == nameof(Debug.LogWarningFormat)
        ...
        public static void PatchPostfix(string format, object[] args)
        {
            ...
            DebugPlus.Log.LogWarning(Format.FormatString(format, args));
        }
    }
