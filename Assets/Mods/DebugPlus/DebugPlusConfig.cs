...
public class DebugPlusConfig
{
    ...
    private static void OverlayConfig(ConfigFile config)
    {
        ...
        ConfigEntries.Add(
            ShowSpawnPointOverlays = config.Bind(
                Overlays,
                "Spawn point overlay",
                false,
                new ConfigDescription(
    ...
    {
        ConfigEntries.Add(
            LoadIntoFactoryOnStart = config.Bind(
                Other,
