...
public class StartRaidAsync : AsyncCommand
{
    ...
    public override object[] ArgumentsValue => new object[] { _mapId, _isBotsEnabled };

    public StartRaidAsync(
        [ConsoleArgument("factory4_day", "Map to start a raid on")] string gameMap,
        [ConsoleArgument(true, "Enable bots")] bool enableBots
    )
    {
        _mapId = gameMap;
